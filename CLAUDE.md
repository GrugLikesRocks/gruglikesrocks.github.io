...
- **Rising Revenant (added 13 Aug 2026 at Giorgio's request).** The studio's first title, discontinued. His CV says "development paused"; he calls it discontinued, and the card uses his word.
  - **Authoritative source is the Notion GDD**, "Game Design Document - Rising Revenant", inside the archived Rising Revenant space under Grug's Lair Gaming Studio: https://app.notion.com/p/78e81e57610b4ac09b046ef731104e39. Use it before any web article. It describes a **hybrid dark fantasy survival / 4X-lite with RPG progression and a risk-to-earn economy**, on **PC and web browser**, played in a **Preparation Phase** (summon revenants, take an outpost, buy Care Packages priced by VRGDA, place defences) then a real-time **Game Phase** (resource oases, revenant missions, outpost warfare with morale, debris recycling, a Black Market Merchant called Obol). Last player standing takes the jackpot, or under 10 survivors can convene the **Final Table** and split it by unanimous vote. Revenant proficiencies are Guardian, Seeker, Harvester and Warmonger. Random events are goblin, earthquake and dragon, countered by palisade, stone and obsidian walls respectively.
  - **Do not publish the economy split.** The GDD contradicts itself: the body says 70% jackpot / 10% missions / 20% platform fee, the executive summary says 65 / 10 / 25. Ask Giorgio before quoting any number.
  - Chain and engine come from public write-ups, not the GDD: **Starknet** and the **Dojo** engine, per [Inside Grug's Lair: The Making of Rising Revenant](https://thelootherald.substack.com/p/inside-grugs-lair-the-making-of-rising) (which also reports a 100,000 $LORDS Frontinus House grant, a six person team and a third and final playtest on 1 Apr 2024, all left off the site). Do not repeat the [Starknet Propulsion Program](https://propulsion.starknet.org/) "up to $1M in STRK" line as if Rising Revenant received it: that describes the programme, and it would clash with his own $1M raised figure.
  - **It now has a full overlay** (`data-project="rising-revenant"`) written from the GDD, plus two images pulled out of Notion on 13 Aug 2026: `screens/rr-luna.jpg` (the Rising Revenant title screen with Luna, from the Eternum collaboration page) and `screens/rr-keyart.jpg` (revenant key art, the "Alpha Release" roadmap icon). Notion file URLs are S3 links signed for **300 seconds**, so re-fetch the page and download immediately if they are ever needed again. Other Notion art lives behind Figma, which needs an authorised Figma connector.
  - Extra facts the overlay uses, both first party: **Luna**, a mobile AI companion for the game, and an **Eternum collaboration** giving season pass holders a free outpost ([page](https://app.notion.com/p/1a663e676e4280ce9e6ac78a5b63f693)). Giacomo may have more art if a better gallery is wanted.
- **Hero stat is 11 products designed and built** (Giorgio, 13 Aug 2026). Do not recompute it from the number of cards on the page. **Solco sits in "The lab"** as entry 01, keeping its `data-project="platform"` overlay, screenshot and live badge. Because a commercial product now sits in the lab, its intro reads "Products and side projects I have designed and built", not "projects I build for the love of it".
